const $portfolio = {
    lists:
        [
            {
                thimg: "./img/p_main1.png", title: "쇼핑몰 메인페이지(한우사랑)", subtitle: "", tools: "HTML, CSS, SCSS, Javascript, Jquery, Ajax, Json, SEO, PG", day: "2 days", concept: "관리자 페이지를 통한 모든 데이터를 파서하여 메인페이지를 제작하였으며, 로그인, 회원가입, 상품 상세페이지, 상품 결제시스템 까지 적용한 쇼핑몰입니다."
            },
            {
                thimg: "./img/admin.png", title: "쇼핑몰 관리자 페이지", subtitle: "", tools: "HTML, CSS, SCSS, Javascript, Jquery, Ajax, Json, Vue, Ckeditor, ECMA", day: "10 days", concept: "동적인 웹 쇼핑몰을 제작하기 위한 관리자 페이지 이며, 배너, FAQ, NOTICE, 회원관리 상품등록등 다양한 기능을 사용할 수 있도록 제작된 페이지 입니다. 또한 전면 모든 페이지는 Back-end와 함께 제작하였으며, My-Sql를 이용하여 데이터를 저장 하였습니다."
            },
            {
                thimg: "./img/hellopet.png", title: "hellopet (PC용)", subtitle: "", tools: "HTML, CSS, Javascript, Jquery, Ajax, Json", day: "1 day", concept: "팀프로젝트로 제작되었으며, 구매하는 소비자들의 패턴과 원스톱 쇼핑 형태를 부각시키고자 전체적으로 기획 및 구성을 하였으며, Fade효과 및 롤링 상품 출력등 다양한 기술 형태를 적용 하였습니다."
            },
            {
                thimg: "./img/today_light.png", title: "today_light (PC용)", subtitle: "", tools: "HTML, CSS, SCSS, Javascript, Jquery, Ajax, Json", day: "1 day", concept: "팀프로젝트로 제작되었으며, Main-Page 1개, Sub-page 3개로 이루어져 있으며, 로그인, Q&A 로 구성되어 있습니다. Q&A는 입력 후 Back-end로 전달되어 JSON이 자동으로 파싱되도록 설계 되어 있습니다."
            },
            {
                thimg: "./img/game.png", title: "틀린그림찾기 게임", subtitle: "", tools: "HTML, CSS, SCSS, Javascript, Jquery, Ajax, Json", day: "1 day", concept: "팀프로젝트로 제작되었으며, Main-Page 1개, Sub-page 3개로 이루어져 있으며, 로그인, Q&A 로 구성되어 있습니다. Q&A는 입력 후 Back-end로 전달되어 JSON이 자동으로 파싱되도록 설계 되어 있습니다."
            },
            {
                thimg: "./img/gigabyte.png", title: "gigabyte (MOBILE)", subtitle: "", tools: "HTML, CSS, SCSS, Javascript, Jquery, Ajax, Json", day: "1 day", concept: "팀프로젝트로 제작되었으며, Main-Page 1개, Sub-page 3개로 이루어져 있으며, 로그인, Q&A 로 구성되어 있습니다. Q&A는 입력 후 Back-end로 전달되어 JSON이 자동으로 파싱되도록 설계 되어 있습니다."
            },
        ]
}
...
$.map(skills, function (a, b) {
    $.map(skills[b], function (c, d) {
        $("#skills>dl").eq(b).append("<dd class='skill_box'>" + c + "</dd>");
    })
})
